/**
 * Whacka client SDK — _detection-math (stub)
 *
...
export const distance = __wk('distance');
export const angle = __wk('angle');
export const mapToScreen = __wk('mapToScreen');
export const createRepCounter = __wk('createRepCounter');
